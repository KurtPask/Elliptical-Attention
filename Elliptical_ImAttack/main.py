...
def get_args_parser():
    ...
    parser.add_argument('--attack', default='none', choices=['pgd', 'fgm', 'sld', 'noise', 'cw', 'spsa', 'none','hsja', 'auto', 'auto-individual', 'fgsm'],
    ...
    parser.add_argument('--dist-eval', action = 'store_true', help='Enabling distributed evaluation')
    ...
    parser.add_argument('--ablation', action = 'store_true', help = 'run ablation of random stretches')
    return parser
...
def main(args):
    ...
    if args.use_wandb:
        ...
        args.job_name = args.job_name + f'_eps_{args.eps}'
    ...
    if args.M_positions or args.ablation: # elliptical model
        model = create_model(
            args.model,
            pretrained=False,
    ...
    if args.eval:
        ...
        test_stats = evaluate(data_loader_val, model, device, attack=args.attack, eps=args.eps, use_wandb = args.use_wandb, output_dir = args.output_dir)
        print('evaluated')
        if args.inc_path:
            result_dict = {}
...
if __name__ == '__main__':
    ...
    #os.environ["WANDB_API_KEY"]="cfcc604ed2e0779cf557cd28d61d9d62334a75b8"
    os.environ["WANDB_API_KEY"]="971b65e110dc2de0cf18976cd29bd2037496ed0d"
    if args.output_dir:
