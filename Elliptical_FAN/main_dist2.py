...
def main():
    ...
    utils_own.init_distributed_mode(args)

    torch.manual_seed(args.seed + utils_own.get_rank())
    np.random.seed(args.seed + utils_own.get_rank())
    ...
    if True:  # args.distributed:
        ...
        else: # existing dataloader already uses distributed sampler so no need to pass this in
    ...
    if args.distributed and args.sync_bn: #sync_bn is false
